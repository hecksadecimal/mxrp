...
def send_message(db, redis, message, user_list=None, force_userlist=False, raw_text=""):
    ...
    # TODO: Fix this for the new redis version. This breaks in ways that I don't really understand, and adjusting it to
    #  the new syntax just throws errors. Might need another major version bump, but not doing that right now.
    # FIXME: See above
    ...
    celery.send_task("newparp.tasks.spamless.check_spam_task", args=(message.chat_id, redis_message, raw_text), countdown=1)
