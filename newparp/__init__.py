...
app.add_url_rule("/rules",  "guides_site_rules", guides.site_rules, methods=("GET",))
app.add_url_rule("/privacy",  "guides_privacy", guides.privacy, methods=("GET",))
app.add_url_rule("/tos",  "guides_tos", guides.tos, methods=("GET",))
