...
def use_db(f):
    ...
    def decorated_function(*args, **kwargs):
        ...
        if g.user_id is not None:
            ...
            queue_user_meta(g, g.redis, request.headers.get("CF-Connecting-IP", request.remote_addr))
        ...
        g.ip_banned = get_ip_banned(request.headers.get("CF-Connecting-IP", request.remote_addr), g.db, g.redis)
